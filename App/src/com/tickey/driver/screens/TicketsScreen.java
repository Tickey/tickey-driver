...
public class TicketsScreen extends ActionBarActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		builder.setMessage(getString(R.string.log_out_dialog))
				.setPositiveButton(getString(R.string.action_logOut),
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		mPhoneSalesCount = (TextView) mItem.getActionView().findViewById(
				R.id.phone_sales_count);
		...
		actionBarBusInfoAdding = new Runnable() {
			...
			public void run() {
				// TODO Auto-generated method stub
				if (meEmployee != null) {
					mBusInfo.setTitle("  " + meEmployee.busAssigned.line
							+ " | " + meEmployee.busAssigned.regNumber);
				} else {
	...
	public void createLocationRequest() {
		mLocationRequest = LocationRequest.create()
				...
				.setInterval(INTVERVAL).setFastestInterval(FASTEST_INTERVAL);
	...
	public void onLocationChanged(Location location) {
		...
		sentLocationToServer(mCurrentLocation.getLongitude(),
				mCurrentLocation.getLatitude());
		MyLog.i(TAG, "Long " + mCurrentLocation.getLongitude() + " Lat "
				+ mCurrentLocation.getLatitude());
	...
	public void onConnectionFailed(ConnectionResult connectionResult) {
		...
		throw new IllegalStateException(
				"Failed connection to location manager "
	...
	public void sentLocationToServer(Double longitude, Double latitude) {
		...
		RequestQueue mRequestQueue = BaseApplication.getInstance()
				.getRequestQueue();

		Type boolResponseType = new TypeToken<ServerResponse<String>>() {
		}.getType();

		String beaconId = this.getIntent().getStringExtra("beaconId");

		String url = String.format(Urls.UPDATE_BUS_LOCATION,
				meEmployee.busAssigned.beaconId);
		...
		GsonRequest<ServerResponse<String>> busLocationUpdateRequest = new GsonRequest<ServerResponse<String>>(
				Method.POST, url, boolResponseType, params,
				Authorization.getAuthorizationHeader(this
						.getApplicationContext()),
				new Listener<ServerResponse<String>>() {

					@Override
					public void onResponse(ServerResponse<String> response) {
						// TODO Auto-generated method stub
