...
//	public static final String STAGE_V1 = "http://stage.api.tickey.me/v1/";
	...
	public static final String LINES = STAGE_V2 + "lines";
	
	public static final String POST_REG_LINE = STAGE_V2 + "lines/%s/bus";
	
	public static final String UPDATE_BUS_LOCATION = STAGE_V2 + "buses/%s/location";
	
	public static final String ME = STAGE_V2 + "auth/me";
	
	public static final String LOGIN = STAGE_V2 + "auth/login/employee";
