...
import com.tickey.driver.data.model.Beacon;
...
//		MyLog.i("test", "Selected Position " + selectedItem + " Position " + position);
	...
	public void startTicketScreen() {
		...
		org.altbeacon.beacon.Beacon driverBeacon = ((VehicleTypeScreen)instance).getDriverBeacon();
//		params.put("regNumber", vehicleNumber);
		if (driverBeacon != null) {
			params.put("beaconId", driverBeacon.getId3());
	...
	public void startTickenScreenWithBeacon() {
		
	
		loadingDialog.show();
		RequestQueue mRequestQueue = BaseApplication.getInstance().getRequestQueue();
		
		Type boolResponseType = new TypeToken<ServerResponse<HashMap<String, String>>>() {}.getType();
...
//		params.put("regNumber", vehicleNumber);
		if (driverBeacon != null) {
			params.put("beacon", driverBeacon.getId3());
			
			
			GsonRequest<ServerResponse<HashMap<String, String>>> busRegRequest = new GsonRequest<ServerResponse<HashMap<String, String>>>(
					Method.POST, url, boolResponseType, params,
					Authorization.getAuthorizationHeader(instance
							.getApplicationContext()),
					new Listener<ServerResponse<HashMap<String, String>>>() {

						@Override
						public void onResponse(ServerResponse<HashMap<String, String>> response) {
							// TODO Auto-generated method stub
							loadingDialog.dismiss();						
			...
			busRegRequest.mContentType = "application/json";
			mRequestQueue.add(busRegRequest);
		}
	}
}
